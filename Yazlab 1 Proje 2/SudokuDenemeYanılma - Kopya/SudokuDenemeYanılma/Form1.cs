...
namespace SudokuDenemeYanılma
{
    public partial class Form1 : Form
    {
        ...
        void sudokuÇöz()
        {
            bool durum = senÇöz(0, 0);
            sudokuTamam(false);
            thread.Abort();
        }

        bool senÇöz(int i, int j)
        {
            int a, b, rakam;
            bool durum = true;
            String sudo;
        ...
        bool uygunMu(int i, int j, int rakam)
        {
            bool durum = true;
            int m, n, a, b;
            a = i - (i % 3);
